...
\textbf{Worked example.} At the 1 October 2025 rebalance, BHARTIARTL had a 12-1 month return of
$+7.45\%$ ($Z=0.38$), a trailing 90-day volatility of $1.03\%$, i.e. Low-Vol $Z=1.18$, and a
trend-quality $R^2$ of $0.76$ ($Z=1.75$), against that day's $\approx$277 eligible stocks. Its
composite score, $0.5\times[0.5(0.38)+0.5(1.18)]+0.5(1.75)=1.27$, ranked 9th overall, placing it
in the top 10 selected that quarter (Table 2).
