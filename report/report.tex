...
concentration cap. A daily 200-day moving-average trend filter overlays this quarterly cycle for
...
\midrule
Final Portfolio Value & Rs 6.88 crore \\
Total Net PnL & Rs 5.88 crore \\
Absolute Return & 588.28\% \\
Annualised Return (CAGR) & 47.12\% \\
Maximum Drawdown & $-$23.78\% \\
Sharpe Ratio (rf = 0\%) & 2.67 \\
Gain-to-Loss Ratio & 2.82 \\
...
Turnover (cumulative, 5-year) & 95.3$\times$ initial capital \\
Total Transaction Costs Paid & Rs 9.53 lakh \\
\bottomrule
\end{tabular}
...
\midrule
BHARTIARTL & Bharti Airtel Ltd. & 5{,}118 & 2{,}079.43 & 15.46\% \\
NAVINFLUOR & Navin Fluorine International Ltd. & 1{,}665 & 5{,}912.89 & 14.30\% \\
EICHERMOT & Eicher Motors Ltd. & 1{,}358 & 7{,}236.72 & 14.28\% \\
FORTIS & Fortis Healthcare Ltd. & 9{,}550 & 883.06 & 12.25\% \\
LAURUSLABS & Laurus Labs Ltd. & 6{,}895 & 1{,}106.90 & 11.09\% \\
MUTHOOTFIN & Muthoot Finance Ltd. & 1{,}900 & 3{,}779.74 & 10.43\% \\
MANAPPURAM & Manappuram Finance Ltd. & 19{,}100 & 306.66 & 8.51\% \\
ASTERDM & Aster DM Quality Care Ltd. & 8{,}154 & 614.16 & 7.28\% \\
FORCEMOT & Force Motors Ltd. & 1 & 20{,}566.00 & 0.03\% \\
\quad Cash & (uninvested, awaiting redeployment) & -- & -- & 6.36\% \\
\bottomrule
\end{tabular}
\caption{Final portfolio composition and weights, as of 31 December 2025. Only 9 of the
permitted 10 slots are filled: the 10th position went unfilled that quarter when total buy
demand exceeded available cash (Section 7), leaving that slice as cash rather than a modelling
error. The 15\% weight cap (Section 3.2) is enforced only at rebalance time; BHARTIARTL's
15.46\% reflects price appreciation since the last rebalance, not a cap violation.}
\end{table}
...
trough in early 2025 is the $-23.78\%$ Maximum Drawdown reported in Table 1; it recovers to a
new high within the same year.}
\end{figure}

For additional context beyond the required list, the strategy also shows Beta $\approx 0.85$
and annualised Alpha $\approx +34.0\%$ against Nifty 500, an Information Ratio of 2.48, a
Sortino Ratio of 3.87, and a Calmar Ratio of 1.98. Beta below 1 shows the outperformance is not
simply leveraged market exposure, and $R^2 \approx 0.49$ shows that a large share of the return
...
\midrule
CAGR & 47.12\% & 15.36\% & 13.35\% \\
Total Return, 2021--2025 & 588.28\% & 104.17\% & 87.07\% \\
Maximum Drawdown & $-$23.78\% & $-$18.84\% & $-$17.56\% \\
Sharpe Ratio (rf = 0\%) & 2.67 & 1.07 & 0.94 \\
Outperformance (CAGR, pp) & -- & +31.76 & +33.76 \\
\bottomrule
\end{tabular}
...
\midrule
2021 & +66.69\% & +30.19\% & +25.04\% \\
2022 & +26.24\% & +1.61\% & +2.15\% \\
2023 & +75.54\% & +25.16\% & +19.55\% \\
2024 & +64.72\% & +15.16\% & +11.76\% \\
2025 & +11.91\% & +6.69\% & +8.96\% \\
\bottomrule
\end{tabular}
...
Rs 5.88cr to Rs 4.26cr, CAGR from 47.1\% to 39.4\%, Sharpe from 2.67 to 2.47,
Gain-to-Loss from 2.82 to 2.64), without even improving full-period maximum drawdown. Since
...
because target rupee amounts are floored to whole shares and the cash pool for the quarter is
fixed, a lower-priority target position can go temporarily unfunded if total buy demand still
exceeds available cash after every sell--this was observed at least once in the backtest. The
unfunded capital sits in cash until the next rebalance rather than being fully deployed. This is
a realistic execution constraint rather than a modelling error, but it means realised weights
can occasionally differ slightly from target weights.
...
out-of-sample stress test (1 January 2026 to 30 June 2026) is a genuine test of generalisation rather
than a formality. The validation discipline described in Section 3.4--locking parameters before
looking at held-out performance--was followed specifically because backtest performance, however
strong, is not a guarantee of future results.
