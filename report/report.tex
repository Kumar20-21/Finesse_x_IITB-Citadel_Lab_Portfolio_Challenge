...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{drawdown.pdf}
...
Sortino Ratio of 3.86, and a Calmar Ratio of 1.96. Beta below 1 shows the outperformance is not
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\textwidth]{quarterly_excess.pdf}
...
each quarter. Because target rupee amounts are floored to whole shares, a lower-priority target
position can go temporarily unfunded if earlier trades in the same rebalance exhaust available
cash--this was observed at least once in the backtest. The unfunded capital sits in cash until
the next rebalance rather than being fully deployed. This is a realistic execution constraint
rather than a modelling error, but it means realised weights can occasionally differ slightly
from target weights.
